            ...
            if (this.options.objectMode) {
                ...
                if (this.streamStart) {
                    ...
                    if (this.options.metadata == ODataMetadataType.none) {
                        ...
                        if (this.streamNextLink) {
                            md = `${md},{"@odata.nextLink":"${this.streamNextLink}"`;
                        }
                        this.push(`${md}","value":[]}`);
                    }
                }
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            if (typeof result.body == "object" && result.body) {
                ...
                if (result.body && result.body.value && result.body.value["nextLink"] && typeof result.body.value["nextLink"] == "string")
                    context["@odata.nextLink"] = result.body.value["nextLink"];
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            if (isCollection && navigationResult.body.value && Array.isArray(navigationResult.body.value)) {
                ...
                if (typeof navigationResult.body["@odata.nextLink"] == "string")
                    context[prop + "@odata.nextLink"] = navigationResult.body["@odata.nextLink"];
